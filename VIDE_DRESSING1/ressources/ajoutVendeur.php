...
<html>
	...
	<script type="text/javascript">					
		...
		function verifAutor(champ){
			if(champ.value.length == 1 && (champ.value == 1 || champ.value == 0)){
				surligne(champ, true);
				return false;
			}
			else{
					...
					<div class="fh5co-intro-text">
						...
						<div class="fh5co-left-position">
							<form method="post" action="ajout.php" onsubmit="return verification(this)" id="inscription">
								...
								<label for="autpr">Autorisation : 
									<div class="infobulle">
										<img src="template/images/interrogation"/>
										<span> 1 si compte admin, 0 sinon </span>
									</div>
								</label>
								<input type="number" name="autor" id="autor" min='0' max='1' onblur="verifAutor(this)"/> <br />

								
								<input type="submit" name="connexion" id="connexion" value="Créer un nouveau vendeur" />						
							</form> <br />
						</div>
					</div>
				</div>
