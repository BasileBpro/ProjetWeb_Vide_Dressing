...
include'C:\wamp64\www\VIDE_DRESSING2\VIDE_DRESSING1\ressources\controleurs\control_ListeEnVente.php';
$liste=$_POST["EnVente"];

$updateListe = new Controller_ListeEnVente;
$updateListe->cUpListe($liste);
							...
							<form id="f0" onchange="existe();" method="post" action="chmtstatutvetement.php">
								<?php
									function actionCompte($compte) {
										...
										$pdoCompte = new Controller_ListeEnVente;
										$test=$pdoCompte->cSelectListe($liste);
										echo '<table class="t3">'."\n";
