	...
	<head>
		...
		<script type="text/javascript">					
			function verification(f){
				...
				if(descriptionOk && tailleOk && prixOk){
					return true;
				}
				else{
				...
				<div class="fh5co-intro js-fullheight">
					<div class="fh5co-intro-text">
						...
						<div >
							...
							<form method="POST" action="ajouter_liste.php" id="ajout">
							...
							<form method="POST" action="Supprimer_liste.php" id="supliste"> 
								<input type="text" name="liste" value="Nom de la liste"onblur="verifVide(this)"/>
							...
							<form method="POST" action="Supprimer_vêtement.php" id="supvet" >
								<input type="text" name="nom_liste" value="Nom de la liste"onblur="verifVide(this)"/> 
								<input type="text" name="code" value="Code du vêtement"onblur="verifVide(this)"/>
								<input type="submit" name="valider" value="Valider suppression" />
							</form>
							...
							<form method="post" action="convPDF.php" id="impre">
								<input type="text" name="nomListe" value="Nom de la liste à imprimer"onblur="verifVide(this)"/>
